...
- **Reviewer audience:** 2 senior PMs + 1 QA lead + 1 SRE rep + 1 support lead
- **Value proposition:** Synthesize messy P0 threads (Slack + tickets) into the top 3 risk signals so the on-call PM can decide rollback / hold / ship within 5 minutes.
